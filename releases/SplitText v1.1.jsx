...
var avoidEndWords = [
    ...
    // Части географических названий (чтобы не разрывать составные названия)
    "новый", "новое", "новая", "новые", "старый", "старое", "старая", "старые",
    "великий", "великое", "великая", "великие", "нижний", "нижнее", "нижняя", "нижние",
    "верхний", "верхнее", "верхняя", "верхние", "южный", "южное", "южная", "южные",
    "северный", "северное", "северная", "северные", "восточный", "восточное", "восточная", "восточные",
    "западный", "западное", "западная", "западные", "красный", "красное", "красная", "красные",
    "белый", "белое", "белая", "белые", "черный", "черное", "черная", "черные",
    "зеленый", "зеленое", "зеленая", "зеленые", "светлый", "светлое", "светлая", "светлые",
    "советский", "советское", "советская", "советские", "магаданский", "камчатский", "ставропольский",
    "краснодарский", "запорожская", "николаевская", "ханты", "мансийский", "ямало", "ненецкий",
    "чукотский", "еврейская", "республика",
    
    // Английские части географических названий
    "new", "old", "san", "saint", "santo", "sao", "porto", "santa", "santa", "sierra",
    "mount", "fort", "grand", "rapid", "rapids", "salt", "lake", "city", "bay", "harbor",
    "harbour", "coast", "springs", "island", "islands", "river", "rivers", "valley",
    "north", "south", "east", "west", "western", "eastern", "northern", "southern",
    "upper", "lower", "great", "little", "big", "long", "short", "high", "low",
    "royal", "king", "queen", "prince", "duke", "county", "state", "province",
    "british", "nova", "scotia", "brunswick", "columbia", "territory", "wales",
    "carolina", "dakota", "virginia", "hampshire", "jersey", "mexico", "york",
    "orleans", "angeles", "francisco", "diego", "antonio", "jose", "vegas",
    "cruces", "alto", "hills", "cedar", "sioux", "falls", "bowling", "green",
    "college", "station", "oklahoma", "kansas", "thunder", "prairie", "mcmurray",
    "john", "gold", "sunshine", "coffs", "macquarie", "hervey", "alice", "isa",
    "broken", "hill", "victor", "buenos", "aires", "rio", "janeiro", "paulo",
    "alegre", "belo", "horizonte", "kuala", "lumpur", "hong", "kong", "delhi",
    "mumbai", "suburban", "addis", "ababa", "cape", "town", "elizabeth", "london",
    "santiago", "chile", "salvador", "domingo", "costa", "rica", "sierra", "leone",
...
function applyAdvancedFormattingRules(text, splitIndex) {
    ...
    // 2. Проверка на составные выражения (фразы, предлоги)
    ...
    // 3. Проверка на специальные термины (города, бренды, имена)
    if (isSpecialTerm(beforeSplit, afterSplit)) {
        ...
        if (newIndex !== splitIndex) {
            ...
            beforeSplit = text.substring(0, splitIndex).trim();
            afterSplit = text.substring(splitIndex + 1).trim();
            $.writeln("Split moved due to special term");
        }
    }
    
    // 4. Оригинальные правила (открывающие символы, специальные символы и т.д.)
